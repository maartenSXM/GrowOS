// from https://github.com/espressif/esp-idf/blob/master/examples/peripherals/usb/device/tusb_serial_device/main/tusb_serial_device_main.c
...
static const char *TAG = "idfUsb.c";
...
void idfUsbInit(void)
    {
    xTaskCreatePinnedToCore(idfUsbTask, "idfUsb", 2048, xTaskGetCurrentTaskHandle(), 10, NULL, 0);
    }
