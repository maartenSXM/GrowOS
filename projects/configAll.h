...
// xxx make adaptable to bsp capabilities
// xxx move to project directory
...
#endif // GOS_BSP_growBoardCpu1=1
 
// cpu1-specific config

#ifdef GOS_BSP_growBoardCpu1
#define GOS_CONFIG_32_KHZ_XTAL		0	// Use external 32 KHz XTAL?
#define GOS_CONFIG_LVGL			0	// use lvgl?
#define GOS_CONFIG_DISPLAY		0	// touchscreen display?
#define GOS_CONFIG_DISPLAY_3_BIT	0	// ... 8 color (else 64k)?
